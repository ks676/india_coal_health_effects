...
def main():
    ...
    # import csv containing retired units
    unit_retired = pd.read_csv('/Users/kiratsingh/Desktop/research/india_coal/health/output/visualization_tables/retired_units_for_exclusion.csv')
    unit_retired = unit_retired[["unit", "status", "retirement_year"]]
    ...
    # merge in retired units
    unit = pd.merge(unit, unit_retired,
                    how="left",
                    left_on=["unit"],
                    right_on=["unit"])
