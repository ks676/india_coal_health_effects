# Goal: Produce correlation plot between age and absolute
...
def main():
    ...
    plt.savefig("/Users/kiratsingh/Documents/coal_health_effects/visualizations/plots/si/age_v_abs_mort_by_unit.png",
                dpi=300)
