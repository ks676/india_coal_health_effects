...
def main():
    ...
    # import csv containing rr by state and conc according to 2019 gbd distribution

    cvd_ihd = pd.read_csv(
            '/Users/kiratsingh/Desktop/research/india_coal/health/output/rr_by_state_ihd_gbd.csv')

    df = df.append(cvd_ihd)
    ...
    cvd_stroke = pd.read_csv(
        '/Users/kiratsingh/Desktop/research/india_coal/health/output/rr_by_state_stroke_gbd.csv')

    df = df.append(cvd_stroke)
    ...
    df.to_csv('/Users/kiratsingh/Desktop/research/india_coal/health/output/rr_by_state_and_endpoint_gbd.csv',
            index=False)
